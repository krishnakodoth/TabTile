...
public class BuildingPlansTileViewActivity extends TileViewActivity {
    ...
    public void onCreate( Bundle savedInstanceState ) {
        ...
        // detail levels
         tileView.addDetailLevel( 0.500f, "m2_5/%d_%d.png");
        // tileView.addDetailLevel( 1.000f, "m2_5/%d_%d.png");
        //tileView.addDetailLevel( 1.000f, "m2_7/%d_%d.png");



        //tileView.addDetailLevel( 1.000f, "tiles/plans/1000/%d_%d.png");
